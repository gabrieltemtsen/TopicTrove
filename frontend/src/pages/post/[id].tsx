...
<Box display={'flex'}  mt={2} mb={-5} alignItems={'flex-start'} gap={'20px'} alignSelf={'stretch'}>
...
<Box >
<Image src='https://bit.ly/48UyfzN' alt='Dan Abramov' h={'640px'}  className='w-full' objectFit={'cover'}/>
</Box>
...
<Text color={'black'} h={'176px'} fontSize={18} flexShrink={0} fontWeight={400} alignSelf={'stretch'} >
A week or so earlier, I was in the gallery with the staff,
putting our heads together about how to hang the
installation, when it dawned on us that I’d never
photographed either Woods or Richardson. Unfortunately, 
they weren’t available to sit for portraits before the festival 
kicked off. But it might seem downright negligent to gallery visitors, 
we thought, that I’d never photographed one of the most illustrious 
cinemagicians of them all, a practically home-grown hero who lived and 
worked not so far, far away: George Lucas. Skywalker Ranch, the Lucasfilm
production facility, was a short drive from the gallery.
</Text>
...
<Box display={'inline-flex'}  flexDirection={'column'} alignItems={'flex-start'} gap={'10px'} padding={'2px 79px 35px 0px'}>
