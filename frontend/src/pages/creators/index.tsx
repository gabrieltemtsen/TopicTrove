...
import { Avatar, Box, Center, Container, Divider,Image, Flex, Heading, Icon, PinInput, PinInputField, Square, Text, Wrap, WrapItem, Input } from '@chakra-ui/react'
...
<Box maxW={'1350px'} marginX={'auto'}>
   ...
   <Box className='creator-intro' bg={'appGreen'} display={'flex'}   h={'297px'} p={'19px 606px 20px 0px'} alignItems={'center'} alignSelf={'stretch'}>
    <Box w={'744px'} h={'258px'} ml={8}>
    <Heading color={'black'} fontSize={'60px'} fontWeight={800}>Find the best Creators</Heading>
    <Text fontSize={20} fontWeight={400} lineHeight={'normal'} mt={4} maxW={'25rem'}> Request quality content from top creators on TopicTRove</Text>
   </Box>
